...
in
{
  options.k.user = {
    ...
    email = mkOpt types.str "none@of.your.business" "The email of the user.";
    fullName = mkOpt types.str "k" "The full name of the user.";
      ...
      assertions = [
        {
          ...
          message = "k.user.name must be set";
        }
        {
          assertion = cfg.home != null;
          message = "k.user.home must be set";
        }
      ];
