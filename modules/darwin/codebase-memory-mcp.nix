...
# kriswill.codebase-memory.package to the fork's own package, so no overlay or pkgs
# wiring is needed. Enable per host with `kriswill.codebase-memory.enable = true;`.
{ inputs, ... }:
{
