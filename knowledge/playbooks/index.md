...
* [Add a Darwin Feature Module](add-module.md) - Create a new nix-darwin feature module — universal (ungated) or host-selective (behind a programs./services. enable); registration is automatic.
