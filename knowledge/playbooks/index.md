...
* [Add a Feature Module](add-module.md) - Create a new darwin or NixOS feature module — universal (ungated) or host-selective (behind a programs./services. enable); registration is automatic.
