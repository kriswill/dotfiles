...
* [Herdr](herdr.md) - herdr — terminal agent multiplexer (run several coding agents in persistent, SSH-reachable sessions); pinned on both OSes to the upstream flake at stable v0.8.2 for in-pane image rendering.
