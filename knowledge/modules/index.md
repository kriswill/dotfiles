...
* [Herdr](herdr.md) - herdr — terminal agent multiplexer (run several coding agents in persistent, SSH-reachable sessions); pinned on both OSes to an upstream preview flake tag for in-pane image rendering.
