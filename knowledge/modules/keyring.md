...
type: NixOS Module
title: Keyring
description: 'snowglobe-factory installer key metadata (NOT GNOME Keyring) — user k''s ssh-ed25519 public key and nebula''s age recipient; do not remove.'
...
snowglobe-factory `keyring` option set consumed by the installer: user `k`'s
...
effect beyond what snowglobe-factory derives from it.
