...
* [Viz Config — Repo Specifics in a Root viz.toml](viz-config-toml.md) - Move every dotfiles-specific string and setting out of the viz code into an optional repo-root viz.toml (strict-parsed at build, embedded normalized in the #data blob); without it okf viz builds a generic viewer with no platform filter, alphabetical types, and a flat legend.
