...
* [Remove Option Gating; Mount Modules Into Hosts](remove-option-gating.md) - Dropped every kriswill.<feature>.enable toggle and lib.mkIf gate — a module mounted into a host is active; host selection moved from option flips to file placement, mirroring the nebula-snowglobe NixOS branch for a clean future merge.
