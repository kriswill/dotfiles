...
`.github/workflows/update-flake-lock.yml`; signing context:
[nas-mount-codesigning](nas-mount-codesigning.md).

## Context

Automating nas-mount's Developer ID signing (see
[nas-mount-codesigning](nas-mount-codesigning.md), 2026-07-10 update) raised
...
- Decision context: [nas-mount-codesigning](nas-mount-codesigning.md);
  manual: `docs/darwin-codesigning.md`.
