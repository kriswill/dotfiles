...
let
  ...
  driver_latest = config.boot.kernelPackages.nvidiaPackages.latest;
  driver_550_107_02 = config.boot.kernelPackages.nvidiaPackages.mkDriver {
    version = "550.107.02";
  ...
  driver_560_28_03 = config.boot.kernelPackages.nvidiaPackages.mkDriver {
    version = "560.28.03";
