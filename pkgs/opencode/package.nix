{
  ...
  # Allow overriding version and hashes
  version ? "1.0.150",
  srcHash ? "sha256-8mFmFFk378g93MbFRwMOJkjuXqq3PVPdCuGVLPn6D44=",
  nodeModulesHash ? "sha256-3swARfDhEfLoaucjiUfse3px40ZBfQsEE8DPgUk/5K0=",
}:
let
  pname = "opencode";
  src = fetchFromGitHub {
